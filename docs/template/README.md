[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_zim/raw/main/dist/nv_zim_v0.99.0.pyz)
...
- Launch *nv_zim_v0.99.0.pyz* by double-clicking (Windows desktop),
