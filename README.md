[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_zim/raw/main/dist/nv_zim_v5.9.5.pyz)
...
Download the latest release [nv_zim_v5.9.5.pyz](https://github.com/peter88213/nv_zim/raw/main/dist/nv_zim_v5.9.5.pyz) (27 KB)

- Launch *nv_zim_v5.9.5.pyz* by double-clicking (Windows desktop),
- or execute `python nv_zim_v5.9.5.pyz` (Windows), resp. `python3 nv_zim_v5.9.5.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_zim_v5.9.5.zip](https://github.com/peter88213/nv_zim/raw/main/dist/nv_zim_v5.9.5.zip) (27 KB)

- Extract the *nv_zim_v5.9.5* folder from the downloaded zipfile "nv_zim_v5.9.5.zip".
